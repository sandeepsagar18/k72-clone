...
const FullScreenNav = () => {
    ...
    return (
        <div ref={fullScreenRef} id='fullscreennav' className='fullscreennav hidden text-white min-h-screen w-full z-50 absolute overflow-y-auto'>
            ...
            <div ref={fullNavLinksRef} className='relative'>
                <div className="navlink flex w-full justify-between lg:p-5 p-2 items-start">
                    ...
                    <div onClick={() => {
                        ...
                        <div className='lg:h-44 h-28 lg:w-1 w-0.5 right-0 rotate-45 origin-top absolute bg-[#D3FD50]'>j</div>

                    </div>
                </div>
                <div className=' py-10'>
                    <div className='link origin-top relative border-t-1 border-white'>
                        <h1 className='font-[font2] text-4xl lg:text-[8vw] text-center lg:leading-[0.8] lg:pt-10 pt-3 uppercase'>Project</h1>
