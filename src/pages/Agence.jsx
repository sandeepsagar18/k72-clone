...
const Agence = () => {
  ...
  return (
    <div className="parent">
      ...
      <div className="px-20  h-full w-full bg-black py-20 flex flex-col gap-10">
        <div className="relative overflow-hidden rounded-4xl">
  <img
    className="h-screen w-full object-cover transition-transform duration-500 hover:scale-110"
    src="https://k72.ca/images/caseStudies/Opto/thumbnailimage_opto.jpg?w=1280&h=960&s=938f0bfb3de1ff2a2846b884eec2d757"
    alt=""
  />

  <h2 className="absolute bottom-20 left-40 text-white uppercase text-6xl">
  ...
  <h2 className="absolute bottom-40 left-60 text-white uppercase text-6xl">
    Fruiti..
  </h2>
</div>
      </div>
